...
| `reportFileExceedSizeAction` | The action when a report file exceeds the `reportFileMaxSize`: <ul><li>`fail`<br/>Makes the action to fail</li><li>`error`<br/>Logs an error</li><li>`warning`<br/>Logs a warning</li><li>`notice`<br/>Logs a notice</li><li>`ignore`<br/>Does nothing and just ignores the file</li></ul>                                                                                                                                                                                                                                                                                                                                                          | `error`                                                                                                              |
