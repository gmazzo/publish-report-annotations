...
| `reportFileMaxSize`     | Maximum size of a single report file to be processed (examples: `1KB`, `3MB`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `10MB`                                                                                                               |
| `invalidFileAction`     | The action when a report file The action when a report file fails to be read: <ul><li>`fail`<br/>Makes the action to fail</li><li>`error`<br/>Reports as a failed check with severity `error`</li><li>`warning`<br/>Reports as a failed check with severity `warning`</li><li>`other`<br/>Reports as a failed check with severity `other`</li><li>`ignore`<br/>Does nothing and just ignores the file</li></ul>                                                                                                                                                                                                                                     | `error`                                                                                                              |
