...
| `invalidFileAction`     | The action when a report file The action when a report file fails to be read: <ul><li>`fail`<br/>Makes the action to fail</li><li>`report`<br/>Reports the invalid files as part of check summary</li><li>`log`<br/>Does nothing and just ignores the file</li></ul>                                                                                                                                                                                                                                                                                                                                                                                | `error`                                                                                                              |
