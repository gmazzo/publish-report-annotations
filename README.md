...
| `summary`          | The kind of summary to report into the check, options:<br/><li>`detailed` prints all information available (may reach [the GitHub's limit](https://docs.github.com/en/rest/checks/runs?apiVersion=2022-11-28#create-a-check-run-output-object) on large builds)</li><li>`totals` only prints aggregated totals</li><li>`off` Does not prints any summary</li> | `detailed`                                                                                                                                                  |
