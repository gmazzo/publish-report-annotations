...
| `ignoreTestRetries` | When multiple executions of a test case are processed in the same report, only the last execution will be computed.<br/><br/>Tests with same `classname` and `name` are assumed to be a retry                                                                                                                                                                                                                                                                                                                                                                                                                       | `false`                                                          |
