...
|<details><summary>✅ asArray</summary><ul><li>✅ asArray when single element, returns it as an array (⌛ <time>)</li><li>✅ asArray when multiple elements, returns the same (⌛ <time>)</li><li>✅ asArray when not a value, returns an empty array (⌛ <time>)</li><li>✅ join joins multiple non black elements (⌛ <time>)</li><li>✅ join joins multiple non black elements, when some are empty or undefined</li><li>✅ shouldFail if error, then true</li><li>✅ shouldFail if only warnings, then false (⌛ <time>)</li><li>✅ shouldFail if only warnings and counting as errors, then true (⌛ <time>)</li><li>✅ shouldFail if only others, then false</li></ul></details>|9|0|0|<time>
|<details><summary>✅ asArray</summary><ul><li>✅ asArray when single element, returns it as an array (⌛ <time>)</li><li>✅ asArray when multiple elements, returns the same</li><li>✅ asArray when not a value, returns an empty array (⌛ <time>)</li></ul></details>|3|0|0|<time>
...
|<details><summary>✅ config</summary><ul><li>✅ config can read config [testsSummaryInput="full", checksSummaryInput="off"] (⌛ <time>)</li><li>✅ config can read config [testsSummaryInput="suitesOnly", checksSummaryInput="off"] (⌛ <time>)</li><li>✅ config can read config [testsSummaryInput="totals", checksSummaryInput="off"] (⌛ <time>)</li><li>✅ config can read config [testsSummaryInput="<other>", checksSummaryInput="off"] (⌛ <time>)</li><li>✅ config can read config [testsSummaryInput="off", checksSummaryInput="full"] (⌛ <time>)</li><li>✅ config can read config [testsSummaryInput="off", checksSummaryInput="totals"] (⌛ <time>)</li><li>✅ config can read config [testsSummaryInput="off", checksSummaryInput="<other>"] (⌛ <time>)</li><li>✅ config when legacy summary is given, overrides new ones [summary="detailed"] (⌛ <time>)</li><li>✅ config when legacy summary is given, overrides new ones [summary="detailedWithoutPassed"] (⌛ <time>)</li><li>✅ config when legacy summary is given, overrides new ones [summary="totals"] (⌛ <time>)</li><li>✅ config when legacy summary is given, overrides new ones [summary="off"] (⌛ <time>)</li><li>✅ config when legacy summary is given, overrides new ones [summary="<other>"] (⌛ <time>)</li></ul></details>|12|0|0|<time>
|<details><summary>✅ fileFilter</summary><ul><li>✅ fileFilter should return true, for files in the PR (⌛ <time>)</li><li>✅ fileFilter should return false and log, for files not in the PR (⌛ <time>)</li><li>✅ fileFilter if file is missing, it should not be filtered</li></ul></details>|3|0|0|<time>
|<details><summary>✅ getPRFiles</summary><ul><li>✅ getPRFiles get without any statuses, returns all files (⌛ <time>)</li><li>✅ getPRFiles get for added, returns just added files (⌛ <time>)</li><li>✅ getPRFiles get other statuses, returns the expected files (⌛ <time>)</li></ul></details>|3|0|0|<time>
|<details><summary>✅ junitParser</summary><ul><li>✅ junitParser given junit xml should obtain annotations (⌛ <time>)</li><li>✅ junitParser given another junit xml should obtain annotations (⌛ <time>)</li><li>✅ junitParser given a junit xml with retries should process it correctly [detectFlakyTests=false] (⌛ <time>)</li><li>✅ junitParser given a junit xml with retries should process it correctly [detectFlakyTests=true] (⌛ <time>)</li><li>✅ junitParser given a junit xml with retries that always fails, should process it correctly (⌛ <time>)</li><li>✅ junitParser given a jest junit xml should obtain annotations (⌛ <time>)</li></ul></details>|6|0|0|<time>
|<details><summary>❌ junitParser</summary><ul><li>✅ junitParser given junit xml should obtain annotations (⌛ <time>)</li><li>✅ junitParser given another junit xml should obtain annotations (⌛ <time>)</li><li>❌ junitParser given a jest junit xml should obtain annotations (⌛ <time>)</li></ul></details>|2|0|1|<time>
|<details><summary>✅ main</summary><ul><li>✅ main delegates to parsers and reports results [filterChecks=true] (⌛ <time>)</li><li>✅ main delegates to parsers and reports results [filterChecks=false] (⌛ <time>)</li><li>✅ main if error and should fail, expect to fail (⌛ <time>)</li><li>✅ main if warnings and should fail, expect to fail (⌛ <time>)</li></ul></details>|4|0|0|<time>
|<details><summary>✅ main</summary><ul><li>✅ main delegates to parsers and reports results (⌛ <time>)</li><li>✅ main if error and should fail, expect to fail</li><li>✅ main if warnings and should fail, expect to fail (⌛ <time>)</li></ul></details>|3|0|0|<time>
...
|<details><summary>❌ org.test.sample.SampleTestSuite</summary><ul><li>🟡 a test skipped()</li><li>✅ a test that passes() (⌛ <time>)</li><li>❌ a test that fails() (⌛ <time>)</li><li>❌ a test that throws an exception() (⌛ <time>)</li></ul></details>|1|1|2|<time>
...
|<details><summary>✅ processFile</summary><ul><li>✅ processFile for a junit file [doNotAnnotate=true] (⌛ <time>)</li><li>✅ processFile for a junit file [doNotAnnotate=false] (⌛ <time>)</li><li>✅ processFile for a checkstyle file [doNotAnnotate=true] (⌛ <time>)</li><li>✅ processFile for a checkstyle file [doNotAnnotate=false] (⌛ <time>)</li><li>✅ processFile for a android lint file [doNotAnnotate=true] (⌛ <time>)</li><li>✅ processFile for a android lint file [doNotAnnotate=false] (⌛ <time>)</li></ul></details>|6|0|0|<time>
...
|<details><summary>✅ readFile</summary><ul><li>✅ readFile should return parsed XML file as JSON (⌛ <time>)</li></ul></details>|1|0|0|<time>
|<details><summary>✅ resolveFile</summary><ul><li>✅ resolveFile when is absolute path, just returns itself (⌛ <time>)</li><li>✅ resolveFile when file exists, just returns itself (⌛ <time>)</li><li>✅ resolveFile when looking for a file, it returns a match (⌛ <time>)</li><li>✅ resolveFile when looking for a file with possible extensions, it returns a match (⌛ <time>)</li><li>✅ resolveFile when looking for a file but extension does not matches, it returns the same (⌛ <time>)</li><li>✅ resolveFile when location is found, it can be used without globbing again (⌛ <time>)</li><li>✅ resolveFile if location is not in git, then it should keep looking (⌛ <time>)</li></ul></details>|7|0|0|<time>
|<details><summary>✅ resolveFile</summary><ul><li>✅ resolveFile when is absolute path, just returns itself (⌛ <time>)</li><li>✅ resolveFile when file exists, just returns itself</li><li>✅ resolveFile when looking for a file, it returns a match (⌛ <time>)</li><li>✅ resolveFile when looking for a file with possible extensions, it returns a match (⌛ <time>)</li><li>✅ resolveFile when looking for a file but extension does not matches, it returns the same (⌛ <time>)</li></ul></details>|5|0|0|<time>
|<details><summary>✅ summaryOf</summary><ul><li>✅ summaryOf only tests, all passed (⌛ <time>)</li><li>✅ summaryOf only tests, with failures</li><li>✅ summaryOf only tests, with retries</li><li>✅ summaryOf only checks (⌛ <time>)</li><li>✅ summaryOf tests and checks</li><li>✅ summaryOf tests and checks, but simplified</li><li>✅ summaryTableOf when summary is suites only (default), returns the expected result (⌛ <time>)</li><li>✅ summaryTableOf when summary is full, returns the expected result (⌛ <time>)</li><li>✅ summaryTableOf when summary is without passed, returns the expected result</li><li>✅ summaryTableOf when only warnings, returns the expected result (⌛ <time>)</li><li>✅ summaryTableOf when summary is totals, returns the expected result (⌛ <time>)</li><li>✅ summaryTableOf when summary is off, returns an empty string</li></ul></details>|12|0|0|<time>
...
|<details><summary>❌ org.test.sample.SampleTestSuite</summary><ul><li>🟡 a test skipped()</li><li>❌ a test that fails() (⌛ <time>)</li><li>❌ a test that throws an exception() (⌛ <time>)</li></ul></details>|1|1|2|<time>
