...
|:-|-|-|-|-
|<details><summary>✅ androidLintParser</summary><ul><li>✅ androidLintParser given lint xml should obtain annotations (⌛ 3.162)</li><li>✅ androidLintParser given lint xml, but filtering, expect no annotations (⌛ 0.019)</li></ul></details>|2|0|0|<time>
...
|<details><summary>✅ asArray</summary><ul><li>✅ asArray when single element, returns it as an array (⌛ 0.005)</li><li>✅ asArray when multiple elements, returns the same (⌛ 0.001)</li><li>✅ asArray when not a value, returns an empty array (⌛ 0.001)</li><li>✅ join joins multiple non black elements (⌛ 0.001)</li><li>✅ join joins multiple non black elements, when some are empty or undefined</li><li>✅ shouldFail if error, then true (⌛ 0.001)</li><li>✅ shouldFail if only warnings, then false</li><li>✅ shouldFail if only warnings and counting as errors, then true</li><li>✅ shouldFail if only others, then false (⌛ 0.001)</li></ul></details>|9|0|0|<time>
...
|<details><summary>✅ checkstyleParser</summary><ul><li>✅ checkstyleParser given detekt xml should obtain annotations (⌛ 3.084)</li><li>✅ checkstyleParser given detekt xml, but filtering, expect no annotations (⌛ 0.012)</li></ul></details>|2|0|0|<time>
...
|<details><summary>✅ config</summary><ul><li>✅ config can read config [testsSummaryInput="full", checksSummaryInput="off"] (⌛ 0.008)</li><li>✅ config can read config [testsSummaryInput="suitesOnly", checksSummaryInput="off"] (⌛ 0.004)</li><li>✅ config can read config [testsSummaryInput="totals", checksSummaryInput="off"] (⌛ 0.003)</li><li>✅ config can read config [testsSummaryInput="<other>", checksSummaryInput="off"] (⌛ 0.018)</li><li>✅ config can read config [testsSummaryInput="off", checksSummaryInput="full"] (⌛ 0.003)</li><li>✅ config can read config [testsSummaryInput="off", checksSummaryInput="totals"] (⌛ 0.009)</li><li>✅ config can read config [testsSummaryInput="off", checksSummaryInput="<other>"] (⌛ 0.001)</li><li>✅ config when legacy summary is given, overrides new ones [summary="detailed"] (⌛ 0.002)</li><li>✅ config when legacy summary is given, overrides new ones [summary="detailedWithoutPassed"] (⌛ 0.001)</li><li>✅ config when legacy summary is given, overrides new ones [summary="totals"] (⌛ 0.001)</li><li>✅ config when legacy summary is given, overrides new ones [summary="off"] (⌛ 0.001)</li><li>✅ config when legacy summary is given, overrides new ones [summary="<other>"] (⌛ 0.001)</li></ul></details>|12|0|0|<time>
|<details><summary>✅ fileFilter</summary><ul><li>✅ fileFilter should return true, for files in the PR (⌛ 0.004)</li><li>✅ fileFilter should return false and log, for files not in the PR (⌛ 0.002)</li><li>✅ fileFilter if file is missing, it should not be filtered (⌛ 0.001)</li></ul></details>|3|0|0|<time>
|<details><summary>✅ getPRFiles</summary><ul><li>✅ getPRFiles get without any statuses, returns all files (⌛ 0.004)</li><li>✅ getPRFiles get for added, returns just added files (⌛ 0.001)</li><li>✅ getPRFiles get other statuses, returns the expected files (⌛ 0.001)</li></ul></details>|3|0|0|<time>
|<details><summary>✅ junitParser</summary><ul><li>✅ junitParser given junit xml should obtain annotations (⌛ 0.027)</li><li>✅ junitParser given another junit xml should obtain annotations (⌛ 0.003)</li><li>✅ junitParser given a junit xml with retries should process it correctly [detectFlakyTests=false] (⌛ 0.008)</li><li>✅ junitParser given a junit xml with retries should process it correctly [detectFlakyTests=true] (⌛ 0.005)</li><li>✅ junitParser given a junit xml with retries that always fails, should process it correctly (⌛ 0.012)</li><li>✅ junitParser given a jest junit xml should obtain annotations (⌛ 0.005)</li></ul></details>|6|0|0|<time>
...
|<details><summary>✅ main</summary><ul><li>✅ main delegates to parsers and reports results [filterChecks=true] (⌛ 0.009)</li><li>✅ main delegates to parsers and reports results [filterChecks=false] (⌛ 0.003)</li><li>✅ main if error and should fail, expect to fail (⌛ 0.001)</li><li>✅ main if warnings and should fail, expect to fail</li></ul></details>|4|0|0|<time>
...
|<details><summary>✅ ParseResults</summary><ul><li>✅ ParseResults mergeWith combine results correctly (⌛ 0.015)</li></ul></details>|1|0|0|<time>
|<details><summary>✅ processFile</summary><ul><li>✅ processFile for a junit file [doNotAnnotate=true] (⌛ 0.006)</li><li>✅ processFile for a junit file [doNotAnnotate=false] (⌛ 0.001)</li><li>✅ processFile for a checkstyle file [doNotAnnotate=true] (⌛ 0.002)</li><li>✅ processFile for a checkstyle file [doNotAnnotate=false] (⌛ 0.002)</li><li>✅ processFile for a android lint file [doNotAnnotate=true] (⌛ 0.001)</li><li>✅ processFile for a android lint file [doNotAnnotate=false] (⌛ 0.002)</li></ul></details>|6|0|0|<time>
...
|<details><summary>✅ publishCheck</summary><ul><li>✅ publishCheck publishes check [checkExists=false] (⌛ 0.007)</li><li>✅ publishCheck publishes check [checkExists=true] (⌛ 0.001)</li></ul></details>|2|0|0|<time>
|<details><summary>✅ readFile</summary><ul><li>✅ readFile should return parsed XML file as JSON (⌛ 0.038)</li></ul></details>|1|0|0|<time>
|<details><summary>✅ readFile</summary><ul><li>✅ readFile should return parsed XML file as JSON (⌛ 0.018)</li></ul></details>|1|0|0|<time>
|<details><summary>✅ resolveFile</summary><ul><li>✅ resolveFile when is absolute path, just returns itself (⌛ 0.004)</li><li>✅ resolveFile when file exists, just returns itself (⌛ 0.001)</li><li>✅ resolveFile when looking for a file, it returns a match (⌛ 3.053)</li><li>✅ resolveFile when looking for a file with possible extensions, it returns a match (⌛ 1.709)</li><li>✅ resolveFile when looking for a file but extension does not matches, it returns the same (⌛ 1.318)</li><li>✅ resolveFile when location is found, it can be used without globbing again (⌛ 1.352)</li><li>✅ resolveFile if location is not in git, then it should keep looking (⌛ 1.439)</li></ul></details>|7|0|0|<time>
...
|<details><summary>✅ summaryOf</summary><ul><li>✅ summaryOf only tests, all passed (⌛ 0.003)</li><li>✅ summaryOf only tests, with failures (⌛ 0.001)</li><li>✅ summaryOf only tests, with retries</li><li>✅ summaryOf only checks</li><li>✅ summaryOf tests and checks (⌛ 0.001)</li><li>✅ summaryOf tests and checks, but simplified</li><li>✅ summaryTableOf when summary is suites only (default), returns the expected result (⌛ 0.001)</li><li>✅ summaryTableOf when summary is full, returns the expected result</li><li>✅ summaryTableOf when summary is without passed, returns the expected result (⌛ 0.001)</li><li>✅ summaryTableOf when only warnings, returns the expected result (⌛ 0.001)</li><li>✅ summaryTableOf when summary is totals, returns the expected result</li><li>✅ summaryTableOf when summary is off, returns an empty string (⌛ 0.001)</li></ul></details>|12|0|0|<time>
